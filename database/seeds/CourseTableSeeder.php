    ...
    public function run()
    {
        $courses = [
            [
                ...
                "description" => "Leadership is often seen an elusive or complex skill, but with this practical course youll soon have it mastered. Whether youre managing a small team or an entire business this course will build essential skills for your time management, team motivation, and personal happiness. Leadership is an essential skill at home, at work, and in every stage of your career. If youre in charge of two or more people at work, this course could change your life"
            ],
            [
            ...
            [
                ...
                "description" => "This Swift 5.1 course is based on our in-person app development bootcamp in London, where weve perfected the curriculum over 4 years of in-person teaching."
            ],
            [
